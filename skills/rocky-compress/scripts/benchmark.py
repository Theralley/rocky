...
def main():
    ...
    # Glob mode: repo_root/tests/rocky-compress/
    # __file__ lives at <repo_root>/skills/rocky-compress/scripts/benchmark.py
    # Walk up four dirs: scripts → rocky-compress → skills → repo_root.
    tests_dir = Path(__file__).resolve().parents[3] / "tests" / "rocky-compress"
